...
/** The floating preview panel shown on hover — description + owner. */
function TaskPreview({ name, description, owner }: TaskCardProps) {
  const hasDescription = !!description && description.trim().length > 0;
  return (
    <div className="rounded-xl border border-line bg-panel p-3.5 shadow-[0_12px_32px_-10px_rgba(0,0,0,0.22)]">
